...
const ensureElysiaClawModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureElysiaClawModelsJson: ensureElysiaClawModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureElysiaClawModelsJsonMock).toHaveBeenCalled();
