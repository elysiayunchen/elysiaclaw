    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["elysiaclaw channels list", "List configured channels and auth profiles."],
          ["elysiaclaw channels status --probe", "Run channel status checks and probes."],
          [
            "elysiaclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["elysiaclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.elysiaclaw.ai/cli/channels",
        )}\n`,
    );
