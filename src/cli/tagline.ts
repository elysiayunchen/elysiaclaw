const DEFAULT_TAGLINE = "All your chats, one ElysiaClaw.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a sakura roll: messy, delicious, effective.",
  ...
  "Built by sakuras, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'elysiaclaw gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ELYSIACLAW_TAGLINE_INDEX;
