    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["elysiaclaw directory self --channel slack", "Show the connected account identity."],
          [
            'elysiaclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["elysiaclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "elysiaclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.elysiaclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
