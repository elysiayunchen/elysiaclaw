      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["elysiaclaw gateway run", "Run the gateway in the foreground."],
            ["elysiaclaw gateway status", "Show service status and probe reachability."],
            ["elysiaclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["elysiaclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.elysiaclaw.ai/cli/gateway")}\n`,
      ),
  );
