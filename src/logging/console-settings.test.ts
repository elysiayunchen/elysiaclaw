...
let originalElysiaClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalElysiaClawTestConsole = process.env.ELYSIACLAW_TEST_CONSOLE;
  process.env.ELYSIACLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalElysiaClawTestConsole === undefined) {
    delete process.env.ELYSIACLAW_TEST_CONSOLE;
  } else {
    process.env.ELYSIACLAW_TEST_CONSOLE = originalElysiaClawTestConsole;
  }
