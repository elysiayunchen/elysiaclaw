...
const defaultTools = createElysiaClawCodingTools({ senderIsOwner: true });
...
describe("createElysiaClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: ElysiaClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createElysiaClawCodingTools({
    ...
    const anthropicTools = createElysiaClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: ElysiaClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createElysiaClawCodingTools({
    ...
    const denied = createElysiaClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createElysiaClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
