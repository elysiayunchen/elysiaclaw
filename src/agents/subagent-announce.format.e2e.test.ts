...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/elysiaclaw/elysiaclaw/issues/31298
    previousFastTestEnv = process.env.ELYSIACLAW_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.ELYSIACLAW_TEST_FAST;
      return;
    }
    process.env.ELYSIACLAW_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // ELYSIACLAW_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("ElysiaClaw runtime context (internal):");
