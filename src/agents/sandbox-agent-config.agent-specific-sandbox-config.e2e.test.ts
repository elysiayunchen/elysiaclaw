...
async function resolveContext(config: ElysiaClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): ElysiaClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
