...
export const DEFAULT_SANDBOX_IMAGE = "elysiaclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "elysiaclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "elysiaclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "elysiaclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "elysiaclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "elysiaclaw-sandbox-browser";
