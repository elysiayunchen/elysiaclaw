...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveElysiaClawAgentDir() returns mainAgentDir
    process.env.ELYSIACLAW_STATE_DIR = tmpDir;
    process.env.ELYSIACLAW_AGENT_DIR = mainAgentDir;
