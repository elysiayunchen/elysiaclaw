...
function resolvePostCompactionIndexSyncMode(config?: ElysiaClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureElysiaClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createElysiaClawCodingTools({
      exec: {
