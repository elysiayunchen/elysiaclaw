...
type CoreToolDefinition = {
  ...
  includeInElysiaClawGroup?: boolean;
};
...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "enter_code_mode",
    label: "enter_code_mode",
    description: "Enter code mode",
    sectionId: "automation",
    profiles: ["coding"],
  },
  {
    id: "exit_code_mode",
    label: "exit_code_mode",
    description: "Exit code mode",
    sectionId: "automation",
    profiles: ["coding"],
  },
  {
  ...
  },
  {
    ...
    description: "Enter worktree isolation",
    sectionId: "automation",
    profiles: ["coding"],
  },
  {
    id: "exit_worktree",
    label: "exit_worktree",
    description: "Exit worktree isolation",
    sectionId: "automation",
    profiles: ["coding"],
  },
  {
    id: "undo_last_action",
    label: "undo_last_action",
    description: "Undo last file operation",
    sectionId: "fs",
    profiles: ["coding"],
  },
  {
    id: "file_history_list",
    label: "file_history_list",
    description: "List file history",
    sectionId: "fs",
    profiles: ["coding"],
  },
  {
    id: "model_speed_probe",
    label: "model_speed_probe",
    description: "Probe model speed",
    sectionId: "automation",
    profiles: ["coding"],
  },
  {
    id: "task_assign",
    label: "task_assign",
    description: "Assign tasks to teammates",
    sectionId: "agents",
    profiles: ["coding"],
  },
];
