...
function resolveAnthropicOpusThinking(cfg: ElysiaClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<ElysiaClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<ElysiaClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<ElysiaClawConfig> = {
        agents: {
          defaults: {
            models: {
