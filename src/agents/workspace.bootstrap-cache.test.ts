...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("elysiaclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("elysiaclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("elysiaclaw-cache-test2-");
