...
type ElysiaClawReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: ElysiaClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createElysiaClawReadTool(base, {
...
export function createElysiaClawReadTool(
  base: AnyAgentTool,
  options?: ElysiaClawReadToolOptions,
): AnyAgentTool {
