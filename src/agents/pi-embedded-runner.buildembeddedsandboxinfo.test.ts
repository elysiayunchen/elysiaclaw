...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/elysiaclaw-sandbox",
    agentWorkspaceDir: "/tmp/elysiaclaw-workspace",
    workspaceAccess: "none",
    containerName: "elysiaclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "elysiaclaw-sbx-browser-test",
    },
