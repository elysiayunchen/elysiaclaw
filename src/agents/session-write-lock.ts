...
const CLEANUP_STATE_KEY = Symbol.for("elysiaclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("elysiaclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("elysiaclaw.sessionWriteLockWatchdogState");
