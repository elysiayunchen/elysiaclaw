...
function resolveAvatarSource(cfg: ElysiaClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ElysiaClawConfig, agentId: string): AgentAvatarResolution {
