...
type ModelsConfig = NonNullable<ElysiaClawConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier ElysiaClaw docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // ElysiaClaw keeps auth in auth-profiles and resolves runtime availability from that store.
