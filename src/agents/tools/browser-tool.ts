...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'User-browser flows need user interaction: profile="user" may require approving a browser attach prompt; profile="chrome-relay" needs the user to click the ElysiaClaw Browser Relay toolbar icon on the tab (badge ON). If user presence is unclear, ask first.',
