...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): ElysiaClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: ElysiaClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: ElysiaClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
