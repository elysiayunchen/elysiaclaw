...
function resolveMemoryToolContext(options: { config?: ElysiaClawConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: ElysiaClawConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: ElysiaClawConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: ElysiaClawConfig): MemoryCitationsMode {
