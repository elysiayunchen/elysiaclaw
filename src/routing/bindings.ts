...
export function listBindings(cfg: ElysiaClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: ElysiaClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ElysiaClawConfig) {
