...
export function listAuthProfileStorePaths(config: ElysiaClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: ElysiaClawConfig, stateDir: string): string[] {
