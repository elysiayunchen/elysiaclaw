...
function resolveResolutionLimits(config: ElysiaClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: ElysiaClawConfig): SecretProviderConfig {
