...
async function runRuntimeWebTools(params: { config: ElysiaClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: ElysiaClawConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
