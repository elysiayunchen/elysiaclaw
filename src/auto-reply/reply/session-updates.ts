...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: ElysiaClawConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: ElysiaClawConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.ELYSIACLAW_TEST_FAST === "1") {
