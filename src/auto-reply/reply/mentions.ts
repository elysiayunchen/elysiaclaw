...
function resolveMentionPatterns(cfg: ElysiaClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ElysiaClawConfig | undefined, agentId?: string): RegExp[] {
