...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\belysiaclaw\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "ElysiaClaw" },
        expected: "[ElysiaClaw]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "ElysiaClaw",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[ElysiaClaw] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
