...
function resolveAcpStreamCoalesceIdleMs(cfg: ElysiaClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ElysiaClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ElysiaClawConfig): AcpProjectionSettings {
