...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("elysiaclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: ElysiaClawConfig): Promise<ContextEngine> {
