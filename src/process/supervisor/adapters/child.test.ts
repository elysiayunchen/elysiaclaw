...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.ELYSIACLAW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.ELYSIACLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.ELYSIACLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
