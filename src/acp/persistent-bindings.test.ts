...
type ConfiguredBinding = NonNullable<ElysiaClawConfig["bindings"]>[number];
...
function resolveBindingRecord(cfg: ElysiaClawConfig, overrides: Partial<BindingRecordInput> = {}) {
