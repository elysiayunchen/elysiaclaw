...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ElysiaClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ElysiaClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: ElysiaClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: ElysiaClawConfig }): Promise<void> {
