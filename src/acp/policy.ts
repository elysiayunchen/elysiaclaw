...
export function isAcpEnabledByPolicy(cfg: ElysiaClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ElysiaClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ElysiaClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ElysiaClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ElysiaClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ElysiaClawConfig, agentId: string): boolean {
