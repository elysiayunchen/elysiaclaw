...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ElysiaClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ElysiaClawConfig): void {
