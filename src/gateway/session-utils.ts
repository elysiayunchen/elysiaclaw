...
import { type ElysiaClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ElysiaClawConfig): string[] {
...
export function listAgentsForGateway(cfg: ElysiaClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ElysiaClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: ElysiaClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ElysiaClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: ElysiaClawConfig): GatewaySessionsDefaults {
