...
const EMPTY_CFG = {} as ElysiaClawConfig;
...
async function applySubagentModelPatch(cfg: ElysiaClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): ElysiaClawConfig {
  return {
    agents: {
      defaults: {
