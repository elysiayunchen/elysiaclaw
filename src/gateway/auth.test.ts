...
describe("gateway auth", () => {
  ...
  it("resolves token/password from ELYSIACLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          ELYSIACLAW_GATEWAY_TOKEN: "env-token",
          ELYSIACLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides ELYSIACLAW_GATEWAY_PASSWORD", () => {
