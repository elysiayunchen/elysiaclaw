import type { GatewayAuthConfig, ElysiaClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: ElysiaClawConfig, password: string): ElysiaClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
