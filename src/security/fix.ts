...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ElysiaClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ElysiaClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: ElysiaClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
