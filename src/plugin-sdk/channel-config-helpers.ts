...
export function createScopedAccountConfigAccessors<ResolvedAccount>(params: {
  resolveAccount: (params: { cfg: ElysiaClawConfig; accountId?: string | null }) => ResolvedAccount;
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: ElysiaClawConfig; accountId?: string | null }) =>
...
export function createScopedChannelConfigBase<
  ResolvedAccount,
  Config extends ElysiaClawConfig = ElysiaClawConfig,
>(params: {
  sectionKey: string;
