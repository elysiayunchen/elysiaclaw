...
const tmpDirMocks = vi.hoisted(() => ({
  resolvePreferredElysiaClawTmpDir: vi.fn(() => "/tmp/openclaw"),
}));
...
describe("pw-tools-core", () => {
  beforeEach(() => {
    ...
    tmpDirMocks.resolvePreferredElysiaClawTmpDir.mockReturnValue("/tmp/openclaw");
  });
  ...
  it("uses preferred tmp dir when waiting for download without explicit path", async () => {
    tmpDirMocks.resolvePreferredElysiaClawTmpDir.mockReturnValue("/tmp/openclaw-preferred");
