...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.ELYSIACLAW_GATEWAY_PORT;
    process.env.ELYSIACLAW_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.ELYSIACLAW_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.ELYSIACLAW_GATEWAY_PASSWORD;
