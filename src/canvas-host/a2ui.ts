...
export const A2UI_PATH = "/__elysiaclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__elysiaclaw__/canvas";

export const CANVAS_WS_PATH = "/__elysiaclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.elysiaclawCanvasA2UIAction.postMessage(...)
  // - Android: window.elysiaclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["elysiaclawCanvasA2UIAction"];
  ...
  globalThis.ElysiaClaw = globalThis.ElysiaClaw ?? {};
  globalThis.ElysiaClaw.postMessage = postToNode;
  globalThis.ElysiaClaw.sendUserAction = sendUserAction;
  globalThis.elysiaclawPostMessage = postToNode;
  globalThis.elysiaclawSendUserAction = sendUserAction;
