...
function resolveAnthropicDefaultAuthMode(cfg: ElysiaClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyTalkApiKey(config: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyTalkConfigNormalization(config: ElysiaClawConfig): ElysiaClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyLoggingDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyContextPruningDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyCompactionDefaults(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
