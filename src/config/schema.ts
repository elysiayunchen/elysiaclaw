...
export type ConfigSchema = ReturnType<typeof ElysiaClawSchema.toJSONSchema>;
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const hints = applyDerivedTags(mapSensitivePaths(ElysiaClawSchema, "", buildBaseHints()));
  const next = {
