...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.elysiaclaw.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.elysiaclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ELYSIACLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.elysiaclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ELYSIACLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.elysiaclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when ELYSIACLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ELYSIACLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.elysiaclaw.jbphoenix.plist",
    },
    {
      name: "prefers ELYSIACLAW_LAUNCHD_LABEL over ELYSIACLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        ELYSIACLAW_PROFILE: "jbphoenix",
        ELYSIACLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ELYSIACLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ELYSIACLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ELYSIACLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ELYSIACLAW_PROFILE: "myprofile",
        ELYSIACLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.elysiaclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
