...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: ElysiaClawConfig;
  let lastUpdatedConfig: ElysiaClawConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/elysiaclaw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/elysiaclaw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/elysiaclaw/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: ElysiaClawConfig) => ElysiaClawConfig) => {
