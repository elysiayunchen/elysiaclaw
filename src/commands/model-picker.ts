...
type PromptDefaultModelResult = { model?: string; config?: ElysiaClawConfig };
...
function resolveConfiguredModelRaw(cfg: ElysiaClawConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: ElysiaClawConfig): string[] {
...
export function applyPrimaryModel(cfg: ElysiaClawConfig, model: string): ElysiaClawConfig {
...
export function applyModelAllowlist(cfg: ElysiaClawConfig, models: string[]): ElysiaClawConfig {
  const defaults = cfg.agents?.defaults;
