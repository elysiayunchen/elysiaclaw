...
export function applyOpencodeZenProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyOpencodeZenConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
