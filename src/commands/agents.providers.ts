...
function resolveDefaultAccountId(cfg: ElysiaClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ElysiaClawConfig): boolean {
...
export function summarizeBindings(cfg: ElysiaClawConfig, bindings: AgentBinding[]): string[] {
