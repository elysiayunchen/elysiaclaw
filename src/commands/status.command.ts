...
export async function statusCommand(
  ...
  const daemonValue = (() => {
    ...
    const installedPrefix = daemon.managedByElysiaClaw ? "installed · " : "";
  ...
  const nodeDaemonValue = (() => {
    ...
    const installedPrefix = nodeDaemon.managedByElysiaClaw ? "installed · " : "";
  ...
  runtime.log(theme.heading("ElysiaClaw status"));
  runtime.log("");
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.elysiaclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.elysiaclaw.ai/troubleshooting");
  runtime.log("");
  ...
  if (gatewayReachable) {
    ...
    runtime.log(`  Fix reachability first: ${formatCliCommand("elysiaclaw gateway probe")}`);
  }
}
