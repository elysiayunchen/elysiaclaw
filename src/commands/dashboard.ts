...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set ELYSIACLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `elysiaclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control ElysiaClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
