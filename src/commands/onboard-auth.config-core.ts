...
export function applyOpenrouterProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyMoonshotConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyQianfanProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyModelStudioProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: ElysiaClawConfig): ElysiaClawConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: ElysiaClawConfig): ElysiaClawConfig {
