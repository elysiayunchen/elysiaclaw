...
export function applyVercelAiGatewayProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
