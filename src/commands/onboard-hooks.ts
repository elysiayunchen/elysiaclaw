...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.elysiaclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("elysiaclaw hooks list")}`,
      `  ${formatCliCommand("elysiaclaw hooks enable <name>")}`,
      `  ${formatCliCommand("elysiaclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
