...
export function applyProviderDefaultModel(cfg: ElysiaClawConfig, modelRef: string): ElysiaClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: ElysiaClawConfig; modelId: string; modelRef: string; profileId: string } {
