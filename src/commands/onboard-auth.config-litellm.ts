...
export function applyLitellmProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyLitellmConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
