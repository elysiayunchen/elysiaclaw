...
export function applyOpencodeGoProviderConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
...
export function applyOpencodeGoConfig(cfg: ElysiaClawConfig): ElysiaClawConfig {
