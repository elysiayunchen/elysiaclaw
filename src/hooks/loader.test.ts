...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "elysiaclaw-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["ELYSIACLAW_BUNDLED_HOOKS_DIR"]);
    process.env.ELYSIACLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: ElysiaClawConfig) => {
