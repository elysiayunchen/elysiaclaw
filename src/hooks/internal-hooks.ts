/**
 * Hook system for ElysiaClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __elysiaclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__elysiaclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
