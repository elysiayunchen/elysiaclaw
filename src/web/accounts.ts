...
export function listWhatsAppAuthDirs(cfg: ElysiaClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ElysiaClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ElysiaClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ElysiaClawConfig): ResolvedWhatsAppAccount[] {
