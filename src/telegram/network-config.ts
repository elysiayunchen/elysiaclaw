...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ELYSIACLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ELYSIACLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ELYSIACLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ELYSIACLAW_TELEGRAM_DNS_RESULT_ORDER
