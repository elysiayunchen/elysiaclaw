...
function makeCfg(overrides?: Partial<ElysiaClawConfig>): ElysiaClawConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): ElysiaClawConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: ElysiaClawConfig) {
