...
export function listChannelMessageActions(cfg: ElysiaClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ElysiaClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: ElysiaClawConfig): boolean {
