...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: ElysiaClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: ElysiaClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: ElysiaClawConfig): string {
