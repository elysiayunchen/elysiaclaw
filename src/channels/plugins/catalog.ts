...
import { discoverElysiaClawPlugins } from "../../plugins/discovery.js";
import type { ElysiaClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ElysiaClawPackageManifest>>;

const ENV_CATALOG_PATHS = ["ELYSIACLAW_PLUGIN_CATALOG_PATHS", "ELYSIACLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ElysiaClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ElysiaClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ElysiaClawPackageManifest;
