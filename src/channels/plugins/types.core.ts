...
export type ChannelAgentToolFactory = (params: { cfg?: ElysiaClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ElysiaClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: ElysiaClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ElysiaClawConfig }) => boolean;
  supportsCards?: (params: { cfg: ElysiaClawConfig }) => boolean;
