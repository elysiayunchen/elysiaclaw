...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: ElysiaClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: ElysiaClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: ElysiaClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: ElysiaClawConfig;
    accountId: string;
    enabled: boolean;
  }) => ElysiaClawConfig;
  deleteAccount?: (params: { cfg: ElysiaClawConfig; accountId: string }) => ElysiaClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: ElysiaClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: ElysiaClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: ElysiaClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: ElysiaClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: ElysiaClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.elysiaclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: ElysiaClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
