...
function mergeSignalAccountConfig(cfg: ElysiaClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ElysiaClawConfig): ResolvedSignalAccount[] {
