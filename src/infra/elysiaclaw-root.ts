...
const CORE_PACKAGE_NAMES = new Set(["elysiaclaw"]);
...
export async function resolveElysiaClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveElysiaClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
