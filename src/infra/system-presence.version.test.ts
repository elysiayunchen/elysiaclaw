...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ELYSIACLAW_VERSION is not set", async () => {
  ...
  it("prefers ELYSIACLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ELYSIACLAW_SERVICE_VERSION when ELYSIACLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ELYSIACLAW_VERSION: " ",
        ELYSIACLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ELYSIACLAW_VERSION and ELYSIACLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ELYSIACLAW_VERSION: " ",
        ELYSIACLAW_SERVICE_VERSION: "\t",
