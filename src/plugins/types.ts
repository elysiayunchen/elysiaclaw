...
export type ElysiaClawPluginConfigSchema = {
...
export type ElysiaClawPluginToolContext = {
...
export type ElysiaClawPluginToolFactory = (
  ctx: ElysiaClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ElysiaClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ElysiaClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<ElysiaClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type ElysiaClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current ElysiaClaw configuration */
  config: ElysiaClawConfig;
 ...
 */
export type ElysiaClawPluginCommandDefinition = {
...
export type ElysiaClawPluginHttpRouteAuth = "gateway" | "plugin";
export type ElysiaClawPluginHttpRouteMatch = "exact" | "prefix";

export type ElysiaClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type ElysiaClawPluginHttpRouteParams = {
  path: string;
  handler: ElysiaClawPluginHttpRouteHandler;
  auth: ElysiaClawPluginHttpRouteAuth;
  match?: ElysiaClawPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type ElysiaClawPluginCliContext = {
  program: Command;
  config: ElysiaClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type ElysiaClawPluginCliRegistrar = (ctx: ElysiaClawPluginCliContext) => void | Promise<void>;

export type ElysiaClawPluginServiceContext = {
  config: ElysiaClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type ElysiaClawPluginService = {
  id: string;
  start: (ctx: ElysiaClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: ElysiaClawPluginServiceContext) => void | Promise<void>;
};

export type ElysiaClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type ElysiaClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: ElysiaClawPluginConfigSchema;
  register?: (api: ElysiaClawPluginApi) => void | Promise<void>;
  activate?: (api: ElysiaClawPluginApi) => void | Promise<void>;
};

export type ElysiaClawPluginModule =
  | ElysiaClawPluginDefinition
  | ((api: ElysiaClawPluginApi) => void | Promise<void>);

export type ElysiaClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | ElysiaClawPluginToolFactory,
    opts?: ElysiaClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: ElysiaClawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: ElysiaClawPluginHttpRouteParams) => void;
  registerChannel: (registration: ElysiaClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: ElysiaClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: ElysiaClawPluginService) => void;
