...
vi.mock("./loader.js", () => ({
  loadElysiaClawPlugins: (params: unknown) => loadElysiaClawPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadElysiaClawPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadElysiaClawPluginsMock.mockClear();
  });
