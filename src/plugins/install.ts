...
const MISSING_EXTENSIONS_ERROR =
  'package.json missing openclaw.extensions; update the plugin package to include openclaw.extensions (for example ["./dist/index.js"]). See https://docs.elysiaclaw.ai/help/troubleshooting#plugin-install-fails-with-missing-openclaw-extensions';

export const PLUGIN_INSTALL_ERROR_CODE = {
  INVALID_NPM_SPEC: "invalid_npm_spec",
  MISSING_ELYSIACLAW_EXTENSIONS: "missing_openclaw_extensions",
  EMPTY_ELYSIACLAW_EXTENSIONS: "empty_openclaw_extensions",
