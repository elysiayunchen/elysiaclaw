...
export const normalizePluginsConfig = (
  config?: ElysiaClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: ElysiaClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ElysiaClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: ElysiaClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
