...
vi.mock("./loader.js", () => ({
  loadElysiaClawPlugins: (...args: unknown[]) => mocks.loadElysiaClawPlugins(...args),
}));
...
describe("registerPluginCliCommands", () => {
  beforeEach(() => {
    ...
    mocks.loadElysiaClawPlugins.mockReturnValue({
      cliRegistrars: [
        {
  ...
  it("forwards an explicit env to plugin loading", () => {
    ...
    expect(mocks.loadElysiaClawPlugins).toHaveBeenCalledWith(
