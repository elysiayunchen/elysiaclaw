...
export const PLUGIN_MANIFEST_FILENAME = "elysiaclaw.plugin.json";
...
// package.json "elysiaclaw" metadata (used for onboarding/catalog)
...
export type ElysiaClawPackageManifest = {
  extensions?: string[];
...
): ElysiaClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
