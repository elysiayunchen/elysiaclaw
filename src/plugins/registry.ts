...
import type {
  ElysiaClawPluginApi,
  ElysiaClawPluginChannelRegistration,
  ElysiaClawPluginCliRegistrar,
  ElysiaClawPluginCommandDefinition,
  ElysiaClawPluginHttpRouteAuth,
  ElysiaClawPluginHttpRouteMatch,
  ElysiaClawPluginHttpRouteHandler,
  ElysiaClawPluginHttpRouteParams,
  ElysiaClawPluginHookOptions,
  ProviderPlugin,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: ElysiaClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: ElysiaClawPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: ElysiaClawPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: ElysiaClawPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: ElysiaClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: ElysiaClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: ElysiaClawPluginHookOptions | undefined,
    config: ElysiaClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: ElysiaClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: ElysiaClawPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as ElysiaClawPluginChannelRegistration).plugin === "object"
        ? (registration as ElysiaClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: ElysiaClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: ElysiaClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: ElysiaClawPluginCommandDefinition) => {
