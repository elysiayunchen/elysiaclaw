    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          ELYSIACLAW_TEST_FAST: "1",
        };
        delete env.ELYSIACLAW_HOME;
        delete env.ELYSIACLAW_STATE_DIR;
        delete env.ELYSIACLAW_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "elysiaclaw.mjs");
