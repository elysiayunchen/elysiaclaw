...
function setTempHome(base: string) {
  ...
  // Ensure tests using HOME isolation aren't affected by leaked ELYSIACLAW_HOME.
  delete process.env.ELYSIACLAW_HOME;
  process.env.ELYSIACLAW_STATE_DIR = path.join(base, ".elysiaclaw");
...
export async function withTempHome<T>(
  ...
  const prefix = opts.prefix ?? "elysiaclaw-test-home-";
