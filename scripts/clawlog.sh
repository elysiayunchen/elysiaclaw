...
show_usage() {
    cat << EOF
clawlog - ElysiaClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ElysiaClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ElysiaClaw logs flow through the macOS unified log (subsystem: ai.elysiaclaw).
