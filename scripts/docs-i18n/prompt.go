...
- Keep product names in English: elysiaclaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the elysiaclaw Gateway, use “Gateway 网关”.
