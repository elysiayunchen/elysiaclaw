...
- ELYSIACLAW_GATEWAY_VERSION = exact package.json version
- ELYSIACLAW_MARKETING_VERSION = short iOS/App Store version
- ELYSIACLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ELYSIACLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
ELYSIACLAW_MARKETING_VERSION = ${MARKETING_VERSION}
ELYSIACLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
