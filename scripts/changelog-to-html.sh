...
if [[ -z "$version_content" ]]; then
  echo "<h2>ElysiaClaw $VERSION</h2>"
  echo "<p>Latest ElysiaClaw update.</p>"
  echo "<p><a href=\"https://github.com/elysiaclaw/elysiaclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
