...
# Output:
# - dist/ElysiaClaw.app
# - dist/ElysiaClaw-<version>.zip
# - dist/ElysiaClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.elysiaclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/ElysiaClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ElysiaClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/ElysiaClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ElysiaClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ElysiaClaw-$VERSION.dSYM.zip"
