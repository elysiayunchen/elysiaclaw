...
**⚠️ CRITICAL: Never review PRs in ElysiaClaw's own project folder!**
...
8. **NEVER start Codex in ~/.elysiaclaw/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/elysiaclaw/** - that's the LIVE ElysiaClaw instance!
...
For long-running background tasks, append a wake trigger to your prompt so ElysiaClaw gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
elysiaclaw system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: elysiaclaw system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
