...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.elysiaclaw/elysiaclaw.json`
...
- The script prints a `MEDIA:` line for ElysiaClaw to auto-attach on supported chat providers.
