...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.elysiaclaw/elysiaclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde elysiaclaw dashboard --no-open en tu escritorio.",
    },
    insecure: {
