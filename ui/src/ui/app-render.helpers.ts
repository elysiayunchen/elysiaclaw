...
import { ElysiaClawApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as ElysiaClawApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as ElysiaClawApp).resetToolStream();
  (state as unknown as ElysiaClawApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as ElysiaClawApp;
