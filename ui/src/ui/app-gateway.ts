...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "elysiaclaw-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as ElysiaClawApp);
      void loadAgents(host as unknown as ElysiaClawApp);
      void loadHealthState(host as unknown as ElysiaClawApp);
      void loadNodes(host as unknown as ElysiaClawApp, { quiet: true });
      void loadDevices(host as unknown as ElysiaClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as ElysiaClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as ElysiaClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as ElysiaClawApp, payload);
