...
public enum ElysiaClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct ElysiaClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ElysiaClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
