...
public enum ElysiaClawTalkCommand: String, Codable, Sendable {
...
public struct ElysiaClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ElysiaClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
