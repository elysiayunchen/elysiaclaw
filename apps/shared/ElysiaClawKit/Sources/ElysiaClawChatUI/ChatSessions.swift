...
public struct ElysiaClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct ElysiaClawChatSessionsDefaults: Codable, Sendable {
...
public struct ElysiaClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct ElysiaClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: ElysiaClawChatSessionsDefaults?
    public let sessions: [ElysiaClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [ElysiaClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
