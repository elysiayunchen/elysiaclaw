...
public typealias ElysiaClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ElysiaClawPlatformImage = UIImage
#endif

public struct ElysiaClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct ElysiaClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ElysiaClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ElysiaClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ElysiaClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct ElysiaClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ElysiaClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ElysiaClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ElysiaClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ElysiaClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ElysiaClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ElysiaClawChatMessageContent].self, forKey: .content) {
...
public struct ElysiaClawChatHistoryPayload: Codable, Sendable {
...
public struct ElysiaClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ElysiaClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ElysiaClawSessionPreviewItem]
}

public struct ElysiaClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ElysiaClawSessionPreviewEntry]

    public init(ts: Int, previews: [ElysiaClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ElysiaClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ElysiaClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ElysiaClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ElysiaClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ElysiaClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ElysiaClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ElysiaClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: ElysiaClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct ElysiaClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
