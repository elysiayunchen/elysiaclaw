...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: ElysiaClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": ElysiaClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": ElysiaClawProtocol.AnyCodable(publicKey),
            "signature": ElysiaClawProtocol.AnyCodable(signature),
            "signedAt": ElysiaClawProtocol.AnyCodable(signedAtMs),
            "nonce": ElysiaClawProtocol.AnyCodable(nonce),
        ]
    }
}
