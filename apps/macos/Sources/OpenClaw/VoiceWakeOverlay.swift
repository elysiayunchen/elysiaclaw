...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.elysiaclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ElysiaClaw windows, but below the system’s pop-up menus.
