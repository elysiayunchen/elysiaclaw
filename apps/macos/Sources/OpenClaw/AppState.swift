...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ElysiaClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ElysiaClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: ElysiaClawConfigFile.loadDict(),
        ...
        ElysiaClawConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/elysiaclaw"
        state.remoteCliPath = ""
        return state
    }
}
