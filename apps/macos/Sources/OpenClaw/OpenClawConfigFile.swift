...
enum ElysiaClawConfigFile {
    private static let logger = Logger(subsystem: "ai.elysiaclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        ElysiaClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ElysiaClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-elysiaclaw-config-file",
            "event": "config.write",
