...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .elysiaclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ElysiaClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ElysiaClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let elysiaclawSelectSettingsTab = Notification.Name("elysiaclawSelectSettingsTab")
}
