...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/elysiaclaw/elysiaclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/elysiaclaw/elysiaclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://elysiaclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ElysiaClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ElysiaClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ElysiaClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ElysiaClawGitCommit") as? String) ??
            "unknown"
    }
