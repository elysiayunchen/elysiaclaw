...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ElysiaClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ElysiaClawProtocol.AnyCodable("start"),
                "name": ElysiaClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
