...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.elysiaclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ElysiaClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__elysiaclaw__/a2ui/").absoluteString + "?platform=macos"
    }
