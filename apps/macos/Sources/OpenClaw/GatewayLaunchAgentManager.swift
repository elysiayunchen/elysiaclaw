...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.elysiaclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".elysiaclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.elysiaclawCommand(
            subcommand: "gateway",
