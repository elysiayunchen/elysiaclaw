...
enum UIStrings {
    static let welcomeTitle = "Welcome to ElysiaClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "elysiaclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ElysiaClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g elysiaclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ElysiaClawChatViewModel(
