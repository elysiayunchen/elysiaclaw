...
/// Menu contents for the ElysiaClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About ElysiaClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "ElysiaClaw Not Configured"
        case .remote:
            "Remote ElysiaClaw Active"
        case .local:
            "ElysiaClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .elysiaclawSelectSettingsTab, object: tab)
        }
    }
