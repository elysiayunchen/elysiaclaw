...
ASC_KEYCHAIN_SERVICE=elysiaclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.elysiaclaw.client
# or
...
- The beta flow regenerates `apps/ios/ElysiaClaw.xcodeproj` from `apps/ios/project.yml` before archiving
