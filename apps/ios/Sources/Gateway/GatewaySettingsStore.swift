...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.elysiaclaw.gateway"
    private static let nodeService = "ai.elysiaclaw.node"
    private static let talkService = "ai.elysiaclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.elysiaclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.elysiaclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("elysiaclaw-gateway.log")
    }
