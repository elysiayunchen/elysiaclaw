...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ElysiaClawLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ElysiaClawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.elysiaclaw.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your ElysiaClaw agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected ElysiaClaw agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while ElysiaClaw is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for ElysiaClaw. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ElysiaClawLocationMode.off.rawValue)
                            Text("While Using").tag(ElysiaClawLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ElysiaClawLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while ElysiaClaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("ElysiaClaw", value: DeviceInfoHelper.elysiaclawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ElysiaClawLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your ElysiaClaw chat and run /pair approve, then tap Connect again."
        }
