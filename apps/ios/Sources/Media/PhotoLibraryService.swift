...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ElysiaClawPhotosLatestParams) async throws -> ElysiaClawPhotosLatestPayload {
        ...
        var results: [ElysiaClawPhotoPayload] = []
        ...
        return ElysiaClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ElysiaClawPhotoPayload
    {
