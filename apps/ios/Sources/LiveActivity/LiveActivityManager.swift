...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.elysiaclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<ElysiaClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = ElysiaClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<ElysiaClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: ElysiaClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> ElysiaClawActivityAttributes.ContentState {
        ElysiaClawActivityAttributes.ContentState(
    ...
    private func idleState() -> ElysiaClawActivityAttributes.ContentState {
        ElysiaClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> ElysiaClawActivityAttributes.ContentState {
        ElysiaClawActivityAttributes.ContentState(
