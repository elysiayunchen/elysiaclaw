---
summary: "Overview of ElysiaClaw onboarding options and flows"
read_when:
...
ElysiaClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`elysiaclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the ElysiaClaw app when you want a fully guided setup on macOS. Docs:
