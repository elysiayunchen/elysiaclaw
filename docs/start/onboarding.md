---
summary: "First-run onboarding flow for ElysiaClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give ElysiaClaw">
...
<Step title="CLI">
  ...
  The app can install the global `elysiaclaw` CLI via npm/pnpm so terminal
