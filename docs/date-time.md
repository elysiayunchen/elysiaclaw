...
ElysiaClaw defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, ElysiaClaw inspects the OS preference (macOS/Windows)
