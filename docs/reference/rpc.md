...
ElysiaClaw integrates external CLIs via JSON-RPC. Two patterns are used today.
...
- ElysiaClaw owns lifecycle when `channels.signal.autoStart=true`.
...
- ElysiaClaw spawns `imsg rpc` as a child process (legacy iMessage integration).
