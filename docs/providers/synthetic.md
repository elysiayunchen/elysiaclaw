---
summary: "Use Synthetic's Anthropic-compatible API in ElysiaClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ElysiaClaw registers it as the
...
Note: ElysiaClaw's Anthropic client appends `/v1` to the base URL, so use
