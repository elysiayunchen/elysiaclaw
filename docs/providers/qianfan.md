---
summary: "Use Qianfan's unified API to access many models in ElysiaClaw"
read_when:
...
3. ElysiaClaw installed on your system
...
4. Copy the API key for use with ElysiaClaw

## CLI setup

```bash
elysiaclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ElysiaClaw Configuration](/gateway/configuration)
