---
summary: "Use NVIDIA's OpenAI-compatible API in ElysiaClaw"
read_when:
  - You want to use NVIDIA models in ElysiaClaw
...
elysiaclaw onboard --auth-choice skip
elysiaclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
