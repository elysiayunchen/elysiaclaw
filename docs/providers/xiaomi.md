---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ElysiaClaw"
read_when:
  - You want Xiaomi MiMo models in ElysiaClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ElysiaClaw uses
