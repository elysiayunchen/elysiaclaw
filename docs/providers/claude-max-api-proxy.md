...
You can point ElysiaClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ElysiaClaw
...
- [Anthropic provider](/providers/anthropic) - Native ElysiaClaw integration with Claude setup-token or API keys
