---
summary: "Run ElysiaClaw with SGLang (OpenAI-compatible self-hosted server)"
read_when:
  - You want to run ElysiaClaw against a local SGLang server
...
ElysiaClaw can connect to SGLang using the `openai-completions` API.

ElysiaClaw can also **auto-discover** available models from SGLang when you opt
...
define `models.providers.sglang`, ElysiaClaw will query:
