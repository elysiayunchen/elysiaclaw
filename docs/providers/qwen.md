---
summary: "Use Qwen OAuth (free tier) in ElysiaClaw"
read_when:
  - You want to use Qwen with ElysiaClaw
...
If you already logged in with the Qwen Code CLI, ElysiaClaw will sync credentials
