...
read_when:
  - You want Zalo Personal (unofficial) support in ElysiaClaw
...
Zalo Personal support for ElysiaClaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
