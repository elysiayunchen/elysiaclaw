...
read_when:
  - You are building a ElysiaClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (elysiaclaw.plugin.json)

Every plugin **must** ship a `elysiaclaw.plugin.json` file in the **plugin root**.
ElysiaClaw uses this manifest to validate configuration **without executing plugin
