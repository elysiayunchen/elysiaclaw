...
read_when:
  - 你想要索引或搜索语义记忆
  - 你正在调试记忆可用性或索引问题
summary: "`elysiaclaw memory`（status/index/search）的 CLI 参考"
title: memory
x-i18n:
...
elysiaclaw memory index
elysiaclaw memory index --verbose
elysiaclaw memory search "release checklist"
