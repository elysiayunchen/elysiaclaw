...
- 生成的 Swift 模型：`apps/macos/Sources/ElysiaClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/elysiaclaw/elysiaclaw/main/dist/protocol.schema.json
