...
本指南总结了在 ElysiaClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 ElysiaClaw 状态目录下。默认为 `~/.elysiaclaw`。如果设置了 `ELYSIACLAW_STATE_DIR`，则使用该目录。

要重置所有内容：

- `elysiaclaw.json` 用于配置
...
- https://docs.elysiaclaw.ai/testing
- https://docs.elysiaclaw.ai/start/getting-started
