---
summary: "Synology Chat webhook setup and ElysiaClaw config"
read_when:
  - Setting up Synology Chat with ElysiaClaw
...
```bash
elysiaclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your ElysiaClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in ElysiaClaw.
...
- Pairing approvals work with:
  - `elysiaclaw pairing list synology-chat`
  - `elysiaclaw pairing approve synology-chat <CODE>`
...
```bash
elysiaclaw message send --channel synology-chat --target 123456 --text "Hello from ElysiaClaw"
elysiaclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
