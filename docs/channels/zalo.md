...
- Install via CLI: `elysiaclaw plugins install @elysiaclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `elysiaclaw plugins install ./extensions/zalo`
   - From npm (if published): `elysiaclaw plugins install @elysiaclaw/zalo`
...
- Approve via:
  - `elysiaclaw pairing list zalo`
  - `elysiaclaw pairing approve zalo <CODE>`
...
- Example: `elysiaclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `elysiaclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `elysiaclaw logs --follow`
