...
read_when:
  - You want ElysiaClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ElysiaClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`elysiaclaw onboard`) and `elysiaclaw channels add` list optional channel plugins.
...
```bash
elysiaclaw plugins install @elysiaclaw/nostr
```

Use a local checkout (dev workflows):

```bash
elysiaclaw plugins install --link <path-to-elysiaclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "elysiaclaw",
        "displayName": "ElysiaClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "elysiaclaw@example.com",
        "lud16": "elysiaclaw@example.com"
      }
    }
  }
}
