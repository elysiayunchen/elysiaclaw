...
ElysiaClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.elysiaclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["elysiaclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
