...
Deploy elysiaclaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/elysiaclaw` — Control UI
...
- `elysiaclaw_STATE_DIR=/data/.elysiaclaw` (recommended)
- `elysiaclaw_WORKSPACE_DIR=/data/workspace` (recommended)
- `elysiaclaw_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your elysiaclaw state + workspace so you can migrate to another host without losing config or memory.
