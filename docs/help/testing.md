...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.elysiaclaw`) mounted to `/home/node/.elysiaclaw`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.elysiaclaw/workspace`) mounted to `/home/node/.elysiaclaw/workspace`
