---
summary: "Where ElysiaClaw loads environment variables and the precedence order"
read_when:
...
ElysiaClaw pulls environment variables from multiple sources. The rule is **never override existing values**.
...
ElysiaClaw supports two env-driven patterns:
