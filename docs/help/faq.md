---
summary: "Frequently asked questions about ElysiaClaw setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up ElysiaClaw?](#whats-the-recommended-way-to-install-and-set-up-elysiaclaw)
  ...
  - [I can't access docs.elysiaclaw.ai (SSL error). What now?](#i-cant-access-docselysiaclawai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or elysiaclaw not recognized](#windows-install-says-git-not-found-or-elysiaclaw-not-recognized)
  ...
  - [How do I install ElysiaClaw on Linux?](#how-do-i-install-elysiaclaw-on-linux)
  - [How do I install ElysiaClaw on a VPS?](#how-do-i-install-elysiaclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask ElysiaClaw to update itself?](#can-i-ask-elysiaclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run ElysiaClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-elysiaclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different ElysiaClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-elysiaclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run ElysiaClaw on a dedicated machine?](#how-important-is-it-to-run-elysiaclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run ElysiaClaw in a VM and what are the requirements](#can-i-run-elysiaclaw-in-a-vm-and-what-are-the-requirements)
- [What is ElysiaClaw?](#what-is-elysiaclaw)
  - [What is ElysiaClaw, in one paragraph?](#what-is-elysiaclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for ElysiaClaw](#what-are-the-top-five-everyday-use-cases-for-elysiaclaw)
  - [Can ElysiaClaw help with lead gen outreach ads and blogs for a SaaS](#can-elysiaclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ElysiaClaw run tasks on a schedule or continuously in the background?](#can-elysiaclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ElysiaClaw saved locally?](#is-all-data-used-with-elysiaclaw-saved-locally)
  - [Where does ElysiaClaw store its data?](#where-does-elysiaclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall ElysiaClaw?](#how-do-i-completely-uninstall-elysiaclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the ElysiaClaw browser run headless?](#can-the-elysiaclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two ElysiaClaw instances talk to each other (local + VPS)?](#can-two-elysiaclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ElysiaClaw load environment variables?](#how-does-elysiaclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of ElysiaClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-elysiaclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ElysiaClaw but keep it installed?](#how-do-i-completely-reset-elysiaclaw-but-keep-it-installed)
  ...
  - [Why doesn't ElysiaClaw reply in a group?](#why-doesnt-elysiaclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do ElysiaClaw, Flawd, and Krill use for models?](#what-do-elysiaclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `elysiaclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-elysiaclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `elysiaclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-elysiaclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run ElysiaClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-elysiaclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart ElysiaClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-elysiaclaw)
  ...
  - [ELI5: `elysiaclaw gateway restart` vs `elysiaclaw gateway`](#eli5-elysiaclaw-gateway-restart-vs-elysiaclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ElysiaClaw to inbound DMs?](#is-it-safe-to-expose-elysiaclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   elysiaclaw logs --follow
   ```

   If RPC is down, fall back to:

   ```bash
   tail -f "$(ls -t /tmp/elysiaclaw/elysiaclaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   elysiaclaw health --json
   elysiaclaw health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://elysiaclaw.ai/install.sh | bash -s -- --install-method git
```

This installs ElysiaClaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/elysiaclaw/elysiaclaw/issues](https://github.com/elysiaclaw/elysiaclaw/issues)
[https://github.com/elysiaclaw/elysiaclaw/pulls](https://github.com/elysiaclaw/elysiaclaw/pulls)

Start with these commands (share outputs when asking for help):

```bash
elysiaclaw status
elysiaclaw models status
elysiaclaw doctor
```

What they do:

- `elysiaclaw status`: quick snapshot of gateway/agent health + basic config.
- `elysiaclaw models status`: checks provider auth + model availability.
- `elysiaclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `elysiaclaw status --all`, `elysiaclaw logs --follow`,
`elysiaclaw gateway status`, `elysiaclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up ElysiaClaw

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://elysiaclaw.ai/install.sh | bash
elysiaclaw onboard --install-daemon
```
...
```bash
git clone https://github.com/elysiaclaw/elysiaclaw.git
cd elysiaclaw
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm elysiaclaw onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `ELYSIACLAW_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `elysiaclaw config get gateway.auth.token` (or generate one: `elysiaclaw doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `elysiaclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `elysiaclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install ElysiaClaw on the new machine.
2. Copy `$ELYSIACLAW_STATE_DIR` (default: `~/.elysiaclaw`) from the old machine.
3. Copy your workspace (default: `~/.elysiaclaw/workspace`).
4. Run `elysiaclaw doctor` and restart the Gateway service.
...
under `~/.elysiaclaw/` (for example `~/.elysiaclaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-elysiaclaw-store-its-data),
...
[https://github.com/elysiaclaw/elysiaclaw/blob/main/CHANGELOG.md](https://github.com/elysiaclaw/elysiaclaw/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.elysiaclaw.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.elysiaclaw.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.elysiaclaw.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docselysiaclawai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/elysiaclaw/elysiaclaw/tree/main/docs](https://github.com/elysiaclaw/elysiaclaw/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://elysiaclaw.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://elysiaclaw.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://elysiaclaw.ai/install.ps1](https://elysiaclaw.ai/install.ps1)
...
```bash
curl -fsSL https://elysiaclaw.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://elysiaclaw.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://elysiaclaw.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://elysiaclaw.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or elysiaclaw not recognized
...
**2) elysiaclaw is not recognized after install**
...
If you still reproduce this on latest ElysiaClaw, track/report it in:

- [Issue #30640](https://github.com/elysiaclaw/elysiaclaw/issues/30640)
...
### How do I install ElysiaClaw on Linux
...
### How do I install ElysiaClaw on a VPS
...
### Can I ask ElysiaClaw to update itself
...
```bash
elysiaclaw update
elysiaclaw update status
elysiaclaw update --channel stable|beta|dev
elysiaclaw update --tag <dist-tag|version>
elysiaclaw update --no-restart
```

If you must automate from an agent:

```bash
elysiaclaw update --yes --no-restart
elysiaclaw gateway restart
```
...
`elysiaclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run ElysiaClaw with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like ElysiaClaw.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `elysiaclaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `elysiaclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `elysiaclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. ElysiaClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so ElysiaClaw can keep replying while a provider is rate-limited.
...
ElysiaClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. ElysiaClaw fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like ElysiaClaw. The onboarding wizard can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Wizard](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `elysiaclaw.json`.

Steps:

1. Enable the plugin: `elysiaclaw plugins enable google-gemini-cli-auth`
2. Login: `elysiaclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. ElysiaClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. ElysiaClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run ElysiaClaw can I connect it to my MacBook Pro
...
- Use `elysiaclaw nodes status` / `elysiaclaw nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but ElysiaClaw authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `elysiaclaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different ElysiaClaw instances
...
If you run ElysiaClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the ElysiaClaw code install. Your state
(`~/.elysiaclaw`) and workspace (`~/.elysiaclaw/workspace`) stay untouched.
...
```bash
npm install -g elysiaclaw@latest
elysiaclaw doctor
elysiaclaw gateway restart
```
...
**ElysiaClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run ElysiaClaw on a dedicated machine
...
ElysiaClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run ElysiaClaw in a VM and what are the requirements
...
### What is ElysiaClaw in one paragraph

ElysiaClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

ElysiaClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for ElysiaClaw
...
### Can ElysiaClaw help with lead gen outreach ads and blogs for a SaaS
...
ElysiaClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

ElysiaClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use ElysiaClaw when you
...
Showcase: [https://elysiaclaw.ai/showcase](https://elysiaclaw.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.elysiaclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.elysiaclaw/elysiaclaw.json`). Precedence is `<workspace>/skills` > `~/.elysiaclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.elysiaclaw/elysiaclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.elysiaclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which ElysiaClaw treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `ELYSIACLAW_SKIP_CRON` is not set.
...
```bash
elysiaclaw cron run <jobId> --force
elysiaclaw cron runs --id <jobId> --limit 50
```
...
### Can ElysiaClaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.elysiaclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-elysiaclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. ElysiaClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.elysiaclaw/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "elysiaclaw": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured ElysiaClaw workspace); ElysiaClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.elysiaclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `ELYSIACLAW_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `ELYSIACLAW_DOCKER_APT_PACKAGES`.
...
ElysiaClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

ElysiaClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, ElysiaClaw auto-selects a provider when it
...
configured and present, ElysiaClaw
...
### Is all data used with ElysiaClaw saved locally

No - **ElysiaClaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.elysiaclaw` + your workspace directory).
...
### Where does ElysiaClaw store its data

Everything lives under `$ELYSIACLAW_STATE_DIR` (default: `~/.elysiaclaw`):

| Path                                                              | Purpose                                                            |
| ----------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$ELYSIACLAW_STATE_DIR/elysiaclaw.json`                           | Main config (JSON5)                                                |
| `$ELYSIACLAW_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$ELYSIACLAW_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$ELYSIACLAW_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$ELYSIACLAW_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$ELYSIACLAW_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$ELYSIACLAW_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$ELYSIACLAW_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$ELYSIACLAW_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.elysiaclaw/agent/*` (migrated by `elysiaclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.elysiaclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.elysiaclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.elysiaclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.elysiaclaw/skills`).

Default workspace is `~/.elysiaclaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.elysiaclaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.elysiaclaw` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall ElysiaClaw
...
`workspace` to the repo root. The ElysiaClaw repo is just source code; keep the
...
ElysiaClaw reads an optional **JSON5** config from `$ELYSIACLAW_CONFIG_PATH` (default: `~/.elysiaclaw/elysiaclaw.json`):

```
$ELYSIACLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.elysiaclaw/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ELYSIACLAW_GATEWAY_TOKEN`).
...
ElysiaClaw enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `elysiaclaw doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one ElysiaClaw.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `ELYSIACLAW_HIDE_BANNER=1`.
...
**Recommended:** run `elysiaclaw configure --section web` and choose a provider.
...
- Daemons read env vars from `~/.elysiaclaw/.env` (or the service environment).
...
### Can the ElysiaClaw browser run headless
...
- Gateway is running: `elysiaclaw gateway status`
- Gateway health: `elysiaclaw status`
- Channel health: `elysiaclaw channels status`
...
### Can two ElysiaClaw instances talk to each other local VPS
...
`elysiaclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
elysiaclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.elysiaclaw/elysiaclaw.json`).
- If you have no backup, re-run `elysiaclaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `elysiaclaw config set` for small changes.
- Use `elysiaclaw configure` for interactive edits.
...
```bash
elysiaclaw gateway --tailscale serve
```
...
### How does ElysiaClaw load environment variables

ElysiaClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.elysiaclaw/.env` (aka `$ELYSIACLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.elysiaclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`ELYSIACLAW_LOAD_SHELL_ENV=1`, `ELYSIACLAW_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`elysiaclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means ElysiaClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.elysiaclaw/.env`:
...
### Is there a way to make a team of ElysiaClaw instances one CEO and many agents
...
### How do I completely reset ElysiaClaw but keep it installed
...
```bash
elysiaclaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ELYSIACLAW_PROFILE`), reset each state dir (defaults are `~/.elysiaclaw-<profile>`).
- Dev reset: `elysiaclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), ElysiaClaw skips the heartbeat run to save API calls.
...
No. ElysiaClaw runs on **your own account**, so if you're in the group, ElysiaClaw can see it.
...
```bash
elysiaclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't ElysiaClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.elysiaclaw/agents/<agentId>/sessions/`.
...
- Use `elysiaclaw doctor` to spot stray workspaces and profile mismatches.
...
ElysiaClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, ElysiaClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
4. Run `elysiaclaw onboard` and choose `Ollama`
...
- for manual switching, use `elysiaclaw models list` and `elysiaclaw models set ollama/<model>`
...
- `elysiaclaw models set ...` (updates just model config)
- `elysiaclaw configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.elysiaclaw/elysiaclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `elysiaclaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do ElysiaClaw, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `elysiaclaw models status`.
...
Yes. ElysiaClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.elysiaclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `elysiaclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so ElysiaClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.elysiaclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.elysiaclaw/agent/*` (migrated by `elysiaclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.elysiaclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `elysiaclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `elysiaclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `elysiaclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.elysiaclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    elysiaclaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), ElysiaClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: ElysiaClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
ElysiaClaw uses provider-prefixed IDs like:
...
ElysiaClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `elysiaclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
elysiaclaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
elysiaclaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
elysiaclaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
elysiaclaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

ElysiaClaw supports both:
...
```
--port > ELYSIACLAW_GATEWAY_PORT > gateway.port > default 18789
```

### Why does elysiaclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `elysiaclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does elysiaclaw gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `ELYSIACLAW_STATE_DIR` mismatch).

Fix:

```bash
elysiaclaw gateway install --force
```
...
ElysiaClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `elysiaclaw gateway --port <port>`.

### How do I run ElysiaClaw in remote mode client connects to a Gateway elsewhere
...
- `elysiaclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `elysiaclaw dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `elysiaclaw doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `ELYSIACLAW_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- If mismatch persists after the one retry, rotate/re-approve the paired device token:
  - `elysiaclaw devices list`
  - `elysiaclaw devices rotate --device <id> --role operator`
- Still stuck? Run `elysiaclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ELYSIACLAW_CONFIG_PATH` (per-instance config)
- `ELYSIACLAW_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `elysiaclaw --profile <name> …` per instance (auto-creates `~/.elysiaclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `elysiaclaw --profile <name> gateway install`.

Profiles also suffix service names (`ai.elysiaclaw.<profile>`; legacy `com.elysiaclaw.*`, `elysiaclaw-gateway-<profile>.service`, `ElysiaClaw Gateway (<profile>)`).
...
```
elysiaclaw tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/elysiaclaw/elysiaclaw-YYYY-MM-DD.log
```
...
- macOS: `$ELYSIACLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.elysiaclaw/logs/...`; profiles use `~/.elysiaclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u elysiaclaw-gateway[-<profile>].service -n 200 --no-pager`
...
If you run the gateway manually, `elysiaclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart ElysiaClaw
...
1. Is the Gateway running? `elysiaclaw gateway status`
2. Is the Gateway healthy? `elysiaclaw status`
3. Does the UI have the right token? `elysiaclaw dashboard`
...
```bash
elysiaclaw channels status
elysiaclaw channels logs --channel telegram
```

Then match the error:

- `BOT_COMMANDS_TOO_MUCH`: the Telegram menu has too many entries. ElysiaClaw already trims to the Telegram limit and retries with fewer commands, but some menu entries still need to be dropped. Reduce plugin/skill/custom commands, or disable `channels.telegram.commands.native` if you do not need the menu.
...
### ELI5 elysiaclaw gateway restart vs elysiaclaw gateway

- `elysiaclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `elysiaclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `elysiaclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [ElysiaClaw assistant setup](/start/elysiaclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
elysiaclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose ElysiaClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `elysiaclaw pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `elysiaclaw pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `elysiaclaw doctor` to surface risky DM policies.
...
```bash
elysiaclaw pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. ElysiaClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
elysiaclaw pairing approve whatsapp <code>
```

List pending requests:

```bash
elysiaclaw pairing list whatsapp
```
...
ElysiaClaw blocks **cross-provider** messaging by default. If a tool call is bound
