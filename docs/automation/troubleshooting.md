...
elysiaclaw system heartbeat last
elysiaclaw logs --follow
elysiaclaw config get agents.defaults.heartbeat
elysiaclaw channels status --probe
```
...
```bash
elysiaclaw config get agents.defaults.heartbeat.activeHours
elysiaclaw config get agents.defaults.heartbeat.activeHours.timezone
elysiaclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
elysiaclaw cron list
elysiaclaw logs --follow
```
