...
read_when:
  ...
  - Wiring external systems into ElysiaClaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your ElysiaClaw config directory (typically `~/.elysiaclaw/hooks/transforms`).
...
- `elysiaclaw webhooks gmail setup` writes `hooks.gmail` config for `elysiaclaw webhooks gmail run`.
