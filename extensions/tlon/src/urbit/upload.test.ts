...
vi.mock("elysiaclaw/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("elysiaclaw/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  async function loadUploadMocks() {
    const { fetchWithSsrFGuard } = await import("elysiaclaw/plugin-sdk/tlon");
