...
import { fetchWithSsrFGuard } from "elysiaclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to ElysiaClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".elysiaclaw", "workspace", "media", "inbound");
 ...
 * Format matches ElysiaClaw's expected attachment structure.
 */
