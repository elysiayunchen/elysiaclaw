import { createScopedChannelConfigBase } from "elysiaclaw/plugin-sdk/compat";
import {
...
} from "elysiaclaw/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). ElysiaClaw adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
