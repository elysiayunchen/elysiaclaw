...
import { createAccountListHelpers, type ElysiaClawConfig } from "elysiaclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: ElysiaClawConfig): ResolvedMattermostAccount[] {
