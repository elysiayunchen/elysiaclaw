...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "elysiaclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: ElysiaClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: ElysiaClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
