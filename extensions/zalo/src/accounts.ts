import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "elysiaclaw/plugin-sdk/account-id";
import { createAccountListHelpers, type ElysiaClawConfig } from "elysiaclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: ElysiaClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ElysiaClawConfig): ResolvedZaloAccount[] {
