...
import type { ElysiaClawConfig, RuntimeEnv } from "elysiaclaw/plugin-sdk/msteams";
...
vi.mock("elysiaclaw/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): ElysiaClawConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
