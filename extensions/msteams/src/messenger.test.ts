...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "elysiaclaw/plugin-sdk/msteams";
...
import { resolvePreferredElysiaClawTmpDir } from "../../../src/infra/tmp-elysiaclaw-dir.js";
import {
  type MSTeamsAdapter,
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(
        path.join(resolvePreferredElysiaClawTmpDir(), "msteams-mention-"),
      );
