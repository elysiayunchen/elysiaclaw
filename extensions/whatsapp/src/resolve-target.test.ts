...
vi.mock("elysiaclaw/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("elysiaclaw/plugin-sdk/whatsapp")>(
    "elysiaclaw/plugin-sdk/whatsapp",
  );
