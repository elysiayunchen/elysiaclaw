...
import { isSecretRef } from "elysiaclaw/plugin-sdk/googlechat";
import { createAccountListHelpers, type ElysiaClawConfig } from "elysiaclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: ElysiaClawConfig): ResolvedGoogleChatAccount[] {
