...
} from "elysiaclaw/plugin-sdk/account-id";
import type { ElysiaClawConfig } from "elysiaclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: ElysiaClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: ElysiaClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: ElysiaClawConfig): string {
