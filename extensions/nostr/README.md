...
Nostr DM channel plugin for ElysiaClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ElysiaClaw. It enables your bot to:
...
# Configure elysiaclaw to use local relay
