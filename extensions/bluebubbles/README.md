...
This directory contains the **BlueBubbles external channel plugin** for ElysiaClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `elysiaclaw/plugin-sdk` helpers.
