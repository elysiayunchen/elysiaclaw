import type { ElysiaClawConfig, ElysiaClawPluginApi } from "elysiaclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: ElysiaClawConfig): { id: string; name: string } {
