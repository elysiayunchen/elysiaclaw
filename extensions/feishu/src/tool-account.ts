...
import type { ElysiaClawPluginApi } from "elysiaclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: ElysiaClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<ElysiaClawPluginApi, "config">;
